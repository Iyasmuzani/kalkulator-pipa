...
function showSegmentResult() {
  ...
  sections.forEach(function (sec) {
    ...
    paramKeys.forEach(function (pk, idx) {
      ...
      html += '<div style="padding-top:12px;display:flex;flex-wrap:wrap;gap:16px;align-items:stretch">';
      ...
      html += '<div style="font-size:12px;color:#e0e0e0;line-height:1.6">' + p.explain + '</div>';
      html += '</div>';
      ...
      // Animation column
      html += '<div style="width:120px;flex-shrink:0;display:flex;flex-direction:column;justify-content:center;margin:0 auto">';
      if (p.animation) {
        html += p.animation;
      }
      html += '</div>';
