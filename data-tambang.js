...
const tambangGuideData=[
  ...
  {n:2,title:'Desain Sistem Dewatering / Slurry',sub:'Perhitungan kapasitas pompa, diameter pipa, dan layout jaringan',
   ...
   checks:['Hitung debit desain: inflow + curah hujan puncak','Tentukan TDH (Total Dynamic Head) termasuk static + friction','Pilih jenis pompa: submersible/slurry sesuai aplikasi','Hitung diameter pipa berdasarkan kecepatan optimal (ASME B31.3)','Desain settling pond: volume, retention time, staging','Buat P&ID (Piping and Instrumentation Diagram)','Hitung kebutuhan listrik dan backup genset','Review desain oleh engineer bersertifikat PII/BNSP'],
   warn:'Faktor keamanan minimal 1.5× untuk debit desain (ASME B31.3). Untuk slurry, gunakan critical velocity per ASME B31.11.'},
  ...
  {n:4,title:'Pemasangan Jalur Pipa HDPE/Baja',sub:'Instalasi jalur pipa dari pit ke settling pond/discharge',
   ...
   checks:['Clearing dan grading jalur pipa sesuai alignment','Gali parit: lebar min. D+600mm, kedalaman min. D+300mm','Buat bedding pasir 150mm di dasar galian','Lakukan butt fusion (HDPE per SNI 4829) atau welding (baja per ASME B31.3)','Uji tekan hidrostatik: 1.5× PN selama minimum 2 jam','Pasang thrust block di setiap belokan dan perubahan diameter','Install expansion joint di titik-titik strategis','Pasang pipa dengan kemiringan min. 2% ke arah drainage','Backfill dengan material seleksi, compaction 95% MDD','Pasang marker post setiap 100m dan di setiap belokan'],
   warn:'Semua pekerjaan las harus oleh welder bersertifikat ASME IX. NDT (radiography) minimal 10% dari total sambungan las per ASME B31.3.'},
  {n:5,title:'Instalasi Sistem Slurry',sub:'Khusus untuk transport material solid/tailing',
   ...
   checks:['Pasang slurry pump pada pondasi beton yang kuat','Install rubber/ceramic lined pipe per ASME B31.11','Pasang knife gate valve di setiap titik isolasi','Gunakan long radius elbow (min. 5D) sesuai ASME B31.11','Pasang wear indicator/port untuk monitoring ketebalan','Install flushing connection di setiap titik rendah','Pasang sampling point untuk analisis konsentrasi slurry','Test run: verifikasi flow rate, pressure, dan settling'],
   warn:'JANGAN biarkan slurry mengendap di dalam pipa. Kecepatan harus selalu di atas critical velocity (Vc) per ASME B31.11.'},
  ...
  {n:7,title:'Operasi & Pemeliharaan Tambang',sub:'SOP harian, jadwal PM, dan manajemen spare parts',
   ...
   warn:'Simpan log operasi dan maintenance selama masa operasi tambang. Diperlukan untuk pelaporan Permen ESDM 26/2018 dan AMDAL.'}
];
