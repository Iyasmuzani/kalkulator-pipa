...
const pipeStandards = {
  'HDPE (High-Density Polyethylene)': {
    ...
    items: [
      ...
      { std: 'SNI 8884-2:2020', pdf: '#', title: 'Sistem Perpipaan Plastik — PE untuk Gas — Bagian 2: Pipa', scope: 'Spesifikasi dimensi dan pengujian pipa PE untuk penyaluran bahan bakar gas. Adopsi ISO 4437-2:2014 (MOD).', type: 'SNI' },
