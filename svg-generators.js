...
<line x1="320" y1="68" x2="320" y2="418" stroke="#00aaff" stroke-width="3.5" opacity=".85" class="pipe-flow"/>
<line x1="355" y1="68" x2="355" y2="490" stroke="rgba(100,180,100,.4)" stroke-width="2" class="pipe-flow-slow" style="stroke-dasharray:5,3"/>
<line x1="50" y1="388" x2="148" y2="388" stroke="#4488ff" stroke-width="2" class="pipe-flow" opacity=".8"/>
<text x="96" y="380" text-anchor="middle" fill="#4488ff" font-size="8" font-family="monospace">PDAM</text>
<line x1="215" y1="500" x2="215" y2="418" stroke="#0088cc" stroke-width="2.5" opacity=".8" class="pipe-flow-reverse"/>
<line x1="175" y1="418" x2="215" y2="418" stroke="#0088cc" stroke-width="2.5" opacity=".8" class="pipe-flow"/>
<line x1="175" y1="365" x2="175" y2="418" stroke="#0088cc" stroke-width="2.5" opacity=".8" class="pipe-flow-reverse"/>
<line x1="205" y1="382" x2="320" y2="382" stroke="#00ff9d" stroke-width="3" opacity=".8" class="pipe-flow"/>
<line x1="320" y1="382" x2="320" y2="418" stroke="#00ff9d" stroke-width="3" opacity=".8" class="pipe-flow"/>
<line x1="390" y1="360" x2="390" y2="382" stroke="#ffaa00" stroke-width="1.8" opacity=".6" class="pipe-flow-slow"/>
<line x1="320" y1="382" x2="390" y2="382" stroke="#ffaa00" stroke-width="1.8" opacity=".6" class="pipe-flow-slow"/>
<line x1="210" y1="77" x2="210" y2="90" stroke="#00aaff" stroke-width="2" opacity=".6" class="pipe-flow"/>
<line x1="210" y1="90" x2="320" y2="90" stroke="#00aaff" stroke-width="2" opacity=".6" class="pipe-flow"/>
<line x1="105" y1="152" x2="320" y2="152" stroke="#00aaff" stroke-width="2.5" opacity=".7" class="pipe-flow"/>
<line x1="105" y1="232" x2="320" y2="232" stroke="#00aaff" stroke-width="2.5" opacity=".7" class="pipe-flow"/>
<line x1="105" y1="312" x2="320" y2="312" stroke="#00aaff" stroke-width="2.5" opacity=".7" class="pipe-flow"/>
${[152,232,312].map(y=>[125,165,205,245,285].map(x=>`<circle cx="${x}" cy="${y}" r="4.5" fill="#00d4ff" opacity=".55"/>`).join('')).join('')}
<line x1="460" y1="152" x2="460" y2="490" stroke="rgba(255,80,60,.4)" stroke-width="1.8" class="pipe-flow"/>
...
<g class="hotspot" id="hp-pump" onclick="selectComp('pump')"><rect x="145" y="355" width="60" height="52" rx="7" fill="#061806" stroke="#00ff9d" stroke-width="2"/><circle cx="175" cy="374" r="12" fill="rgba(0,255,157,.08)" stroke="#00ff9d" stroke-width="1.5"/><g class="pump-impeller" style="transform-origin:175px 374px"><line x1="175" y1="365" x2="175" y2="383" stroke="#00ff9d" stroke-width="1.2" opacity=".6"/><line x1="167" y1="374" x2="183" y2="374" stroke="#00ff9d" stroke-width="1.2" opacity=".6"/><line x1="169" y1="368" x2="181" y2="380" stroke="#00ff9d" stroke-width="1" opacity=".4"/><line x1="181" y1="368" x2="169" y2="380" stroke="#00ff9d" stroke-width="1" opacity=".4"/></g><text x="175" y="398" text-anchor="middle" fill="#00ff9d" font-size="8" font-family="monospace" font-weight="bold">POMPA</text></g>
...
<line x1="440" y1="387" x2="205" y2="387" stroke="#4488ff" stroke-width="1.5" class="pipe-flow-reverse" opacity=".45"/>
<g class="hotspot" id="hp-ground-tank" onclick="selectComp('ground-tank')"><rect x="95" y="496" width="230" height="72" rx="4" fill="#030d1a" stroke="#0088cc" stroke-width="2"/><rect x="100" y="510" width="220" height="52" rx="2" fill="url(#waterGrad)" opacity=".7" class="water-shimmer"/><text x="210" y="510" text-anchor="middle" fill="#0088cc" font-size="9" font-family="monospace" font-weight="bold">TANGKI BAWAH</text></g>
...
<line x1="235" y1="165" x2="345" y2="165" stroke="rgba(0,200,255,.4)" stroke-width="1" class="water-shimmer"/>
<line x1="235" y1="172" x2="345" y2="172" stroke="rgba(0,200,255,.2)" stroke-width="1" class="water-shimmer"/>
<text x="290" y="195" text-anchor="middle" fill="rgba(0,150,255,.4)" font-size="7" font-family="monospace">SUMP PIT</text>
<g class="hotspot" id="hp-dewater-pump" onclick="selectComp('dewater-pump')"><rect x="265" y="150" width="50" height="35" rx="5" fill="#1a0e00" stroke="#ff8c42" stroke-width="1.5"/><circle cx="290" cy="163" r="8" fill="rgba(255,140,66,.1)" stroke="#ff8c42" stroke-width="1.2"/><g class="pump-impeller" style="transform-origin:290px 163px"><line x1="290" y1="157" x2="290" y2="169" stroke="#ff8c42" stroke-width="1" opacity=".6"/><line x1="284" y1="163" x2="296" y2="163" stroke="#ff8c42" stroke-width="1" opacity=".6"/><line x1="286" y1="159" x2="294" y2="167" stroke="#ff8c42" stroke-width=".8" opacity=".4"/><line x1="294" y1="159" x2="286" y2="167" stroke="#ff8c42" stroke-width=".8" opacity=".4"/></g><text x="290" y="180" text-anchor="middle" fill="#ff8c42" font-size="7" font-family="monospace" font-weight="bold">DW PUMP</text></g>
<line x1="290" y1="150" x2="290" y2="60" stroke="#4da6ff" stroke-width="3" opacity=".8" class="pipe-flow-reverse"/>
<line x1="290" y1="60" x2="480" y2="60" stroke="#4da6ff" stroke-width="3" opacity=".8" class="pipe-flow"/>
<line x1="480" y1="30" x2="480" y2="60" stroke="#4da6ff" stroke-width="3" opacity=".8" class="pipe-flow"/>
...
<line x1="290" y1="95" x2="290" y2="110" stroke="#4da6ff" stroke-width="2" class="pipe-flow-slow"/>
<rect x="485" y="25" width="90" height="80" rx="4" fill="rgba(10,26,10,.7)" stroke="#66cc66" stroke-width="1.5"/>
<rect x="490" y="55" width="80" height="45" rx="2" fill="rgba(0,100,180,.15)" stroke="rgba(102,204,102,.3)" class="water-shimmer"/>
<line x1="495" y1="68" x2="565" y2="68" stroke="rgba(102,204,102,.3)" stroke-width="1" class="water-shimmer"/>
...
<g class="hotspot" id="hp-slurry-pump" onclick="selectComp('slurry-pump')"><rect x="60" y="260" width="80" height="50" rx="5" fill="none" stroke="#ffb347" stroke-width="1.5" opacity="0"/><circle cx="100" cy="278" r="10" fill="rgba(255,179,71,.08)" stroke="#ffb347" stroke-width="1.2"/><g class="pump-impeller" style="transform-origin:100px 278px"><line x1="100" y1="271" x2="100" y2="285" stroke="#ffb347" stroke-width="1" opacity=".6"/><line x1="93" y1="278" x2="107" y2="278" stroke="#ffb347" stroke-width="1" opacity=".6"/><line x1="95" y1="273" x2="105" y2="283" stroke="#ffb347" stroke-width=".8" opacity=".4"/><line x1="105" y1="273" x2="95" y2="283" stroke="#ffb347" stroke-width=".8" opacity=".4"/></g><text x="100" y="300" text-anchor="middle" fill="#ffb347" font-size="7" font-family="monospace" font-weight="bold">SLURRY</text><text x="100" y="310" text-anchor="middle" fill="#ffb347" font-size="6" font-family="monospace">PUMP</text></g>
<line x1="140" y1="285" x2="430" y2="285" stroke="#aaaaaa" stroke-width="4" opacity=".5"/>
<line x1="140" y1="285" x2="430" y2="285" stroke="#aaaaaa" stroke-width="2.5" opacity=".8" class="pipe-flow"/>
...
<line x1="8" y1="28" x2="35" y2="28" stroke="#4da6ff" stroke-width="3" class="pipe-flow"/><text x="41" y="31" fill="#7a9ab8" font-size="7" font-family="monospace">Dewatering line</text>
<line x1="8" y1="42" x2="35" y2="42" stroke="#aaaaaa" stroke-width="3" class="pipe-flow"/><text x="41" y="45" fill="#7a9ab8" font-size="7" font-family="monospace">Slurry pipeline</text>
...
<line x1="110" y1="100" x2="155" y2="100" stroke="#6dd5ed" stroke-width="2.5" opacity=".7" class="pipe-flow"/>
...
<line x1="220" y1="100" x2="270" y2="100" stroke="#00aacc" stroke-width="3" opacity=".7" class="pipe-flow"/>
...
<g class="hotspot" id="hp-reservoir" onclick="selectComp('reservoir')"><rect x="270" y="70" width="90" height="60" rx="6" fill="rgba(10,26,46,.8)" stroke="#4da6ff" stroke-width="2"/><rect x="275" y="90" width="80" height="35" rx="2" fill="rgba(0,100,200,.15)" class="water-shimmer"/><line x1="280" y1="100" x2="350" y2="100" stroke="rgba(77,166,255,.3)" stroke-width="1" class="water-shimmer"/><line x1="280" y1="108" x2="350" y2="108" stroke="rgba(77,166,255,.2)" stroke-width="1" class="water-shimmer"/><text x="315" y="85" text-anchor="middle" fill="#4da6ff" font-size="8" font-family="monospace" font-weight="bold">RESERVOIR</text><text x="315" y="120" text-anchor="middle" fill="#3a6a8b" font-size="6.5" font-family="monospace">Ground Tank</text></g>
<g class="hotspot" id="hp-booster-pump" onclick="selectComp('booster-pump')"><rect x="375" y="78" width="55" height="44" rx="5" fill="rgba(0,26,10,.8)" stroke="#00cc66" stroke-width="1.5"/><circle cx="402" cy="95" r="10" fill="rgba(0,204,102,.08)" stroke="#00cc66" stroke-width="1.2"/><g class="pump-impeller" style="transform-origin:402px 95px"><line x1="402" y1="88" x2="402" y2="102" stroke="#00cc66" stroke-width="1" opacity=".6"/><line x1="395" y1="95" x2="409" y2="95" stroke="#00cc66" stroke-width="1" opacity=".6"/><line x1="397" y1="90" x2="407" y2="100" stroke="#00cc66" stroke-width=".8" opacity=".4"/><line x1="407" y1="90" x2="397" y2="100" stroke="#00cc66" stroke-width=".8" opacity=".4"/></g><text x="402" y="115" text-anchor="middle" fill="#00cc66" font-size="7" font-family="monospace" font-weight="bold">BOOSTER</text></g>
<line x1="360" y1="100" x2="375" y2="100" stroke="#4da6ff" stroke-width="2.5" class="pipe-flow"/>
<line x1="430" y1="100" x2="460" y2="100" stroke="#00cc66" stroke-width="3" opacity=".8" class="pipe-flow"/>
<line x1="460" y1="100" x2="460" y2="180" stroke="#6677dd" stroke-width="3" opacity=".7" class="pipe-flow"/>
<text x="470" y="145" fill="#6677dd" font-size="7" font-family="monospace" transform="rotate(90,470,145)">PIPA UTAMA</text>
<line x1="460" y1="180" x2="460" y2="420" stroke="#6677dd" stroke-width="3" opacity=".5" class="pipe-flow"/>
<line x1="200" y1="200" x2="460" y2="200" stroke="#6677dd" stroke-width="2.5" opacity=".6" class="pipe-flow"/>
<line x1="200" y1="280" x2="460" y2="280" stroke="#6677dd" stroke-width="2" opacity=".5" class="pipe-flow"/>
<line x1="200" y1="360" x2="460" y2="360" stroke="#6677dd" stroke-width="2" opacity=".4" class="pipe-flow"/>
...
<g class="hotspot" id="hp-hydrant" onclick="selectComp('hydrant')"><rect x="490" y="265" width="30" height="40" rx="3" fill="#2e0a0a" stroke="#ff4444" stroke-width="1.5"/><circle cx="505" cy="280" r="6" fill="rgba(255,68,68,.15)" stroke="#ff4444" stroke-width="1"/><circle cx="505" cy="295" r="2.5" fill="#ff4444"/><text x="505" y="312" text-anchor="middle" fill="#ff4444" font-size="6.5" font-family="monospace">HIDRAN</text></g>
...
<line x1="8" y1="28" x2="35" y2="28" stroke="#00aacc" stroke-width="3" class="pipe-flow"/><text x="41" y="31" fill="#7a9ab8" font-size="7" font-family="monospace">Pipa transmisi</text>
<line x1="8" y1="42" x2="35" y2="42" stroke="#6677dd" stroke-width="2.5" class="pipe-flow"/><text x="41" y="45" fill="#7a9ab8" font-size="7" font-family="monospace">Pipa distribusi</text>
...
${[80,160,240,320,400,480,560].map((x,i)=>`<line x1="${x}" y1="5" x2="${x-8}" y2="28" stroke="rgba(0,188,212,.12)" stroke-width="1.5" class="rain-drop" style="animation-delay:${i*0.15}s"/>`).join('')}
...
<line x1="150" y1="140" x2="450" y2="140" stroke="#00acc1" stroke-width="2.5" opacity=".75" class="pipe-flow"/>
...
<line x1="180" y1="65" x2="180" y2="140" stroke="#0097a7" stroke-width="2.5" opacity=".65" class="pipe-flow"/>
<line x1="310" y1="65" x2="310" y2="140" stroke="#0097a7" stroke-width="2.5" opacity=".65" class="pipe-flow"/>
<line x1="440" y1="65" x2="440" y2="140" stroke="#0097a7" stroke-width="2.5" opacity=".65" class="pipe-flow"/>
<line x1="450" y1="140" x2="450" y2="375" stroke="#0288d1" stroke-width="4.5" opacity=".25"/>
<line x1="450" y1="140" x2="450" y2="375" stroke="#0288d1" stroke-width="2.8" opacity=".75" class="pipe-flow"/>
...
<line x1="450" y1="375" x2="450" y2="400" stroke="#039be5" stroke-width="3.5" opacity=".45" class="pipe-flow"/>
<line x1="450" y1="400" x2="530" y2="400" stroke="#2e7d32" stroke-width="2.5" opacity=".55" class="pipe-flow"/>
<line x1="530" y1="400" x2="530" y2="430" stroke="#2e7d32" stroke-width="2.5" opacity=".35" class="pipe-flow-slow"/>
<line x1="100" y1="72" x2="100" y2="400" stroke="rgba(255,143,0,.25)" stroke-width="2" class="pipe-flow-slow" style="stroke-dasharray:5,4"/>
...
<line x1="8" y1="42" x2="30" y2="42" stroke="#0097a7" stroke-width="2" class="pipe-flow"/><text x="36" y="45" fill="#7a9ab8" font-size="7" font-family="monospace">Tail pipe</text>
<line x1="8" y1="56" x2="30" y2="56" stroke="#00acc1" stroke-width="2.5" class="pipe-flow"/><text x="36" y="59" fill="#7a9ab8" font-size="7" font-family="monospace">Collecting pipe (no slope)</text>
<line x1="8" y1="70" x2="30" y2="70" stroke="#0288d1" stroke-width="3" class="pipe-flow"/><text x="36" y="73" fill="#7a9ab8" font-size="7" font-family="monospace">Downpipe · Discharge</text>
